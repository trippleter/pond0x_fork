...
exports.applyCliArgsToTracer = exports.addCliParams = exports.runTask = exports.createTracerTask = exports.registerTask = void 0;
const config_1 = require("hardhat/config");
const wrapper_1 = require("../wrapper");
const check_opcodes_1 = require("./check-opcodes");
function registerTask(taskName) {
    return createTracerTask(taskName).setAction((args, hre, runSuper) => {
        (0, wrapper_1.wrapHardhatProvider)(hre);
        return runTask(args, hre, runSuper);
    });
}
exports.registerTask = registerTask;
function createTracerTask(taskName) {
    return addCliParams((0, config_1.task)(taskName, `Run hardhat: ${taskName}`));
}
exports.createTracerTask = createTracerTask;
async function runTask(args, hre, runSuper) {
